...
def main() -> None:
    ...
    ap.add_argument("--easy-max-tokens", type=int, default=45000)
    ap.add_argument("--medium-max-tokens", type=int, default=75000)
    ap.add_argument("--hard-max-tokens", type=int, default=75000)
    ap.add_argument("--easy-min-completion-tokens", type=int, default=1500)
    ap.add_argument("--medium-min-completion-tokens", type=int, default=2500)
    ap.add_argument("--hard-min-completion-tokens", type=int, default=2500)
